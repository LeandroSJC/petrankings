...
async function main() {
  const productId = 'cmtz382608ee126fed4a26cc';
  const slug = 'premier-formula-gatos-castrados-frango';
  ...
  console.log('Resultado do Score Frango:', audit.scoreTotal, audit.classificacaoFaixa);

  const product = await prisma.product.upsert({
    where: { id: productId },
    update: {
      slug,
      commercialName: 'PremieR Formula Gatos Castrados Sabor Frango',
      brand: 'PremieR',
      ...
      sourceUrl: 'https://premierpet.com.br/produto/premier-formula-gatos-castrados-frango/',
      ...
      labelCollectionDate: new Date('2026-09-13T10:49:00Z'),
      ...
      editorialOpinion:
        'Alimento Super Premium para gatos castrados a partir dos 6 meses de idade, com densidade proteica exemplar na Matéria Seca (37,22%), conservantes 100% naturais e suporte ao trato urinário através do método SSR.',
  ...
  console.log('✓ Produto Frango cadastrado com sucesso!');
